...
(function(){
  ...
  function exportReportExcelInternal(){
    ...
    if(window.toast) window.toast(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تصدير تقرير المصروفات'):'تم تصدير تقرير المصروفات');
  }
  ...
  function printReportInternal(){
    ...
    if(!w){ alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المتصفح منع نافذة الطباعة'):'المتصفح منع نافذة الطباعة'); return; }
  }
  ...
  function saveBudgetFromFormInternal(){
    ...
    if(!child){ if(window.toast) window.toast(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب اسم الابن'):'اكتب اسم الابن'); else alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب اسم الابن'):'اكتب اسم الابن'); return; }
    if(!isFinite(amount) || amount<0){ if(window.toast) window.toast(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب ميزانية صحيحة'):'اكتب ميزانية صحيحة'); else alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب ميزانية صحيحة'):'اكتب ميزانية صحيحة'); return; }
