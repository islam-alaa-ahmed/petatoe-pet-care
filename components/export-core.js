...
(function(){
  ...
  ns.runLegacy = ns.runLegacy || function(fn){
    try{
      ...
      if(typeof window.toast === 'function') window.toast(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تعذر تنفيذ التصدير'):'تعذر تنفيذ التصدير');
    }
  };
