...
(function(){
  ...
  ns.excelRows = function(rows, filename, sheetName){
    ...
    if(window.XLSX && XLSX.utils && !window.__PETATOE_XLSX_STUB__){
      ...
      ns.notify && ns.notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تصدير CSV بديل لأن مكتبة Excel غير متاحة.'):'تم تصدير CSV بديل لأن مكتبة Excel غير متاحة.');
    }
  };
  ns.excelTable = function(table, filename, sheetName){
    var rows = ns.tableToRows(table);
    if(!rows.length){ ns.notify && ns.notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لا توجد بيانات للتصدير'):'لا توجد بيانات للتصدير'); return; }
  ...
  ns.excelWorkbook = function(sheets, filename){
    ...
    if(window.XLSX && XLSX.utils && !window.__PETATOE_XLSX_STUB__){
      ...
      ns.notify && ns.notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تصدير TXT/CSV بديل لأن مكتبة Excel غير متاحة.'):'تم تصدير TXT/CSV بديل لأن مكتبة Excel غير متاحة.');
    }
  };
