...
(function(){
  ...
  if(!window.XLSX){
    var utils={
      ...
      sheet_to_json:function(){notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مكتبة Excel غير متاحة حالياً، لا يمكن قراءة ملف Excel.'):'مكتبة Excel غير متاحة حالياً، لا يمكن قراءة ملف Excel.'); return [];},
    ...
    window.XLSX={
      utils:utils,
      read:function(){notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مكتبة Excel غير متاحة حالياً، لا يمكن قراءة الملف.'):'مكتبة Excel غير متاحة حالياً، لا يمكن قراءة الملف.'); return {SheetNames:[],Sheets:{}};},
      writeFile:function(wb,filename){
        ...
        notify(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مكتبة Excel غير متاحة، تم تصدير نسخة CSV بديلة بدون كسر الصفحة.'):'مكتبة Excel غير متاحة، تم تصدير نسخة CSV بديلة بدون كسر الصفحة.');
      }
    };
