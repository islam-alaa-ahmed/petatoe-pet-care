...
(function(){
  ...
  window.PETATOE_I18N_DICTIONARIES.ar = {
    ...
    sidebar:{operations:'⚙️ إدارة التشغيل',home:'🏠 الرئيسية',children:'👨‍👩‍👧 مصروفات الأبناء',transactions:'⭐ العمليات',analytics:'📈 التحليلات',management:'🏢 الإدارة',settings:'⚙️ الإعدادات والصلاحيات',tagline:'.Care. Love. PETATOE'},
