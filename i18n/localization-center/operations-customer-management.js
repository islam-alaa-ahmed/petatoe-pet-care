...
(function(){
  ...
  var CATALOG={
    ar:{
      ...
      import:{title:'مراجعة رفع العملاء',waiting:'في انتظار اختيار ملف',readingFile:'جارٍ قراءة ملف العملاء',parsingFile:'جارٍ تحليل ملف العملاء',validatingRows:'جارٍ التحقق من {count} صف',readyForApproval:'اكتملت المراجعة. اضغط موافقة لحفظ البيانات في Supabase',reviewSummary:'الإجمالي: {total} | جديد: {created} | تحديث: {updated} | بدون تغيير: {unchanged} | مستبعد: {rejected}',approveSave:'موافقة وحفظ في Supabase',cancel:'إلغاء',preparingSave:'جارٍ تجهيز البيانات للحفظ',savingToSupabase:'جارٍ حفظ العملاء في Supabase',refreshingLatestData:'تم اكتشاف تحديث أحدث. جارٍ دمج الملف مع أحدث بيانات Supabase',savedToSupabase:'تم حفظ {count} عميل في Supabase',savedToast:'تم حفظ العملاء في Supabase',saveFailed:'تعذر حفظ العملاء في Supabase. راجع الاتصال والصلاحيات',supabaseUnavailable:'مسار الحفظ المؤكد في Supabase غير متاح',noValidRows:'لم يتم العثور على صفوف عملاء صالحة',excelUnavailable:'مكتبة Excel غير متاحة',readFailed:'تعذر قراءة ملف العملاء'}
    },
    en:{
      ...
      import:{title:'Customer Import Review',waiting:'Waiting for a file',readingFile:'Reading customer file',parsingFile:'Parsing customer file',validatingRows:'Validating {count} rows',readyForApproval:'Review complete. Approve to save the data to Supabase',reviewSummary:'Total: {total} | New: {created} | Updated: {updated} | Unchanged: {unchanged} | Rejected: {rejected}',approveSave:'Approve and Save to Supabase',cancel:'Cancel',preparingSave:'Preparing data for save',savingToSupabase:'Saving customers to Supabase',refreshingLatestData:'A newer update was detected. Merging the file with the latest Supabase data',savedToSupabase:'Saved {count} customers to Supabase',savedToast:'Customers saved to Supabase',saveFailed:'Could not save customers to Supabase. Check connection and permissions',supabaseUnavailable:'Confirmed Supabase save is unavailable',noValidRows:'No valid customer rows found',excelUnavailable:'Excel library is unavailable',readFailed:'Could not read the customer file'}
    }
  };
