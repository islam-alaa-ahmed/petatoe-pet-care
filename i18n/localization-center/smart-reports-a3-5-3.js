...
(function(){
  ...
  var ar={smartReportsSource:{
    ...
    interactions:{
      linkedReport:'التقرير المرتبط',pinIcon:'📌',openedFromRecommendations:'تم فتح {report} من شاشة التوصيات.',backIcon:'↩️',backToRecommendations:'رجوع لتقرير التوصيات',backToRecommendationsShort:'رجوع للتوصيات',growthOpportunities:'فرص النمو',highPriority:'أولوية عالية',urgentIntervention:'تدخل عاجل',noItems:'لا توجد عناصر في هذا القسم حاليًا.',details:'تفاصيل',itemCount:'{count} عنصر',searchStart:'ابدأ الكتابة للبحث في العملاء والخدمات والسيارات والفواتير...',searchMinChars:'اكتب حرفين على الأقل للبحث.',searchNoData:'لا توجد بيانات متاحة للبحث.',searchNoResults:'لا توجد نتائج مطابقة.',customers:'العملاء',transactions:'المعاملات',services:'الخدمات',operations:'العمليات',vehicles:'السيارات',invoices:'الفواتير',invoiceNumber:'رقم الفاتورة'
    }
  }};
  var en={smartReportsSource:{
    readiness:{loading:'Loading Smart Reports data…'},
    vehicleEfficiency:{allYears:'All Years',allMonths:'All Months',allVehicles:'All Vehicles',allPayments:'All Payment Methods',noData:'No data matches the vehicle-efficiency filters.',total:'Total',reset:'Reset',title:'Vehicle Efficiency Analysis'},
    interactions:{
      linkedReport:'Linked report',pinIcon:'📌',openedFromRecommendations:'{report} was opened from Recommendations.',backIcon:'↩️',backToRecommendations:'Back to Recommendations report',backToRecommendationsShort:'Back to Recommendations',growthOpportunities:'Growth Opportunities',highPriority:'High Priority',urgentIntervention:'Urgent Intervention',noItems:'There are currently no items in this section.',details:'Details',itemCount:'{count} items',searchStart:'Start typing to search customers, services, vehicles, and invoices...',searchMinChars:'Enter at least two characters to search.',searchNoData:'No data is available to search.',searchNoResults:'No matching results.',customers:'Customers',transactions:'Transactions',services:'Services',operations:'Operations',vehicles:'Vehicles',invoices:'Invoices',invoiceNumber:'Invoice Number'
    }
  }};
