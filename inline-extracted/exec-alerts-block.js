...
(function(){
  ...
  function monthArabic(m){return MAR[String(m)]||MAR[Number(m)]||String(m||'')}
...
(function(){
  ...
  function clientName(r){return String((r&&r.client)||'غير محدد').trim()||'غير محدد'}
  function serviceName(r){return String((r&&r.item)||'غير محدد').trim()||'غير محدد'}
  function monthKey(r){return (MAR[normalizeMonth(r.month,r.date)]||normalizeMonth(r.month,r.date)||'-')+' '+(getYear(r)||'')}
