...
(function(){
  ...
  window.petatoePrintPdf = function(){
    ...
    if(!zone || !zone.innerHTML || !zone.innerHTML.trim()){
      alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لا يوجد محتوى للطباعة. اضغط "تحديث" أولاً.'):'لا يوجد محتوى للطباعة. اضغط "تحديث" أولاً.');
      return;
    }
    if(zone.innerText && zone.innerText.indexOf('لا توجد بيانات بعد') !== -1){
      alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لا توجد بيانات متاحة للطباعة. قم باستيراد البيانات أولاً.'):'لا توجد بيانات متاحة للطباعة. قم باستيراد البيانات أولاً.');
      return;
    }
    ...
    if(!win){
      alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لم يتمكن المتصفح من فتح نافذة الطباعة. تحقق من إعدادات الـ Popup.'):'لم يتمكن المتصفح من فتح نافذة الطباعة. تحقق من إعدادات الـ Popup.');
      return;
    }
  ...
  window.PETATOEHeaderPdfSafeOpen = window.PETATOEHeaderPdfSafeOpen || function(event){
    ...
    if(typeof window.petatoeOpenPdfModal === 'function') window.petatoeOpenPdfModal();
    else alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('محرك تقرير PDF لم يكتمل تحميله بعد. أعد المحاولة خلال ثانية.'):'محرك تقرير PDF لم يكتمل تحميله بعد. أعد المحاولة خلال ثانية.');
    return false;
  };
