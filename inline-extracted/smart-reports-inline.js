...
(function(){
  ...
  window.petSaveUser=function(){var id=byId('pu_id')?byId('pu_id').value:''; var users=petGetUsers(); var username=(byId('pu_username')?byId('pu_username').value.trim():''); if(!username){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اسم الدخول مطلوب'):'اسم الدخول مطلوب');return} if(users.some(function(u){return u.username===username&&u.id!==id})){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اسم الدخول موجود بالفعل'):'اسم الدخول موجود بالفعل');return} var u=id?users.find(function(x){return x.id===id}):null; if(!u){u={id:'u_'+Date.now(),createdAt:new Date().toISOString(),lastLogin:''}; users.push(u)}; u.username=username; u.fullName=(byId('pu_fullName')?byId('pu_fullName').value.trim():'')||username; u.job=byId('pu_job')?byId('pu_job').value.trim():''; u.phone=byId('pu_phone')?byId('pu_phone').value.trim():''; u.email=byId('pu_email')?byId('pu_email').value.trim():''; u.role=byId('pu_role')?byId('pu_role').value:'viewer'; u.status=byId('pu_status')?byId('pu_status').value:'active'; var pass=byId('pu_password')?byId('pu_password').value:''; var sec=window.PETATOEPasswordSecurity; if(pass){if(sec&&sec.setPassword)sec.setPassword(u,pass);} else if(!id&&!(sec&&sec.hasCredential&&sec.hasCredential(u))&&!u.password){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('كلمة المرور مطلوبة للمستخدم الجديد'):'كلمة المرور مطلوبة للمستخدم الجديد');return;} petSaveUsers(users); log(id?'User Updated':'User Created',u.username,'warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حفظ المستخدم'):'تم حفظ المستخدم'); renderSettingsPanel()};
  ...
  window.petDeleteUser=function(id){var users=petGetUsers(); var u=users.find(function(x){return x.id===id}); if(!u)return; if(u.role==='superadmin'){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لا يمكن حذف Super Admin'):'لا يمكن حذف Super Admin');return} var reason=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('سبب حذف المستخدم؟'):'سبب حذف المستخدم؟'); if(!reason)return; users=users.filter(function(x){return x.id!==id}); petSaveUsers(users); log('User Deleted',u.username+' | '+reason,'warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حذف المستخدم'):'تم حذف المستخدم'); renderSettingsPanel()};
  window.petResetUserPass=function(id){var users=petGetUsers(), u=users.find(function(x){return x.id===id}); if(!u)return; var p=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('كلمة المرور الجديدة للمستخدم '):'كلمة المرور الجديدة للمستخدم '+u.username,''); if(!p)return; var sec=window.PETATOEPasswordSecurity; if(sec&&sec.setPassword)sec.setPassword(u,p); petSaveUsers(users); log('Password Reset',u.username,'warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تغيير كلمة المرور'):'تم تغيير كلمة المرور')};
  window.petSetCurrentUser=function(id){var u=petGetUsers().find(function(x){return x.id===id}); if(!u)return; if(u.status!=='active'){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المستخدم غير نشط'):'المستخدم غير نشط');return} writeJSON(PET_CURRENT_KEY,id); u.lastLogin=new Date().toISOString(); petSaveUsers(petGetUsers().map(function(x){return x.id===id?u:x})); petSetCurrentRoleFromUser(); log('Current User Changed',u.username+' / '+u.role,'warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تفعيل المستخدم: '):'تم تفعيل المستخدم: '+u.fullName); renderSettingsPanel(); applyGovernance()};
  window.petSaveRoleMatrix=function(){var roles=petGetRoles(); Object.keys(PET_ROLE_NAMES).forEach(function(r){if(r!=='superadmin')roles[r]=[]}); document.querySelectorAll('.pet-role-matrix input[type=checkbox]').forEach(function(c){if(c.checked){var r=c.getAttribute('data-role'), p=c.getAttribute('data-perm'); if(!roles[r])roles[r]=[]; if(roles[r].indexOf(p)<0)roles[r].push(p)}}); roles.superadmin=PET_PERMS.map(function(p){return p[0]}); petSaveRoles(roles); log('Permissions Updated','Role matrix saved','warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حفظ الصلاحيات'):'تم حفظ الصلاحيات'); renderSettingsPanel()};
  window.petResetRoleMatrix=function(){if(!confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('إرجاع صلاحيات الأدوار للافتراضي؟'):'إرجاع صلاحيات الأدوار للافتراضي؟'))return; removeJSON(PET_ROLES_KEY); log('Permissions Reset','Default role matrix restored','warn'); renderSettingsPanel()};
  window.petSaveSecuritySettings=function(){petSaveSecurity({requireDeleteReason:!!(byId('secDeleteReason')&&byId('secDeleteReason').checked),requireEditReason:!!(byId('secEditReason')&&byId('secEditReason').checked),lockSensitiveDeletes:!!(byId('secLockSensitive')&&byId('secLockSensitive').checked),enableAudit:!!(byId('secAudit')&&byId('secAudit').checked),sensitiveAmount:parseFloat(byId('secAmount')?byId('secAmount').value:0)||0,managerPasswordHash:(byId('secManagerPass')&&byId('secManagerPass').value&&window.PETATOEPasswordSecurity)?window.PETATOEPasswordSecurity.hashPassword(byId('secManagerPass').value):(petSecurity().managerPasswordHash||null)}); log('Security Settings Updated','Sensitive operations settings saved','warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حفظ إعدادات الأمان'):'تم حفظ إعدادات الأمان')};
  window.petSaveMyProfile=function(){var users=petGetUsers(), cu=petCurrentUser(), u=users.find(function(x){return x.id===cu.id}); if(!u)return; u.fullName=(byId('profName')?byId('profName').value.trim():'')||u.fullName; u.phone=byId('profPhone')?byId('profPhone').value.trim():u.phone; u.email=byId('profEmail')?byId('profEmail').value.trim():u.email; var p=byId('profPass')?byId('profPass').value:''; if(p){var sec=window.PETATOEPasswordSecurity;if(sec&&sec.setPassword)sec.setPassword(u,p);} petSaveUsers(users); log('My Profile Updated',u.username,'info'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تحديث بياناتي'):'تم تحديث بياناتي'); renderSettingsPanel()};
  ...
  window.petClearAuditLog=function(){if(!confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مسح سجل النشاط؟'):'مسح سجل النشاط؟'))return; removeJSON(LOG_KEY); log('Audit Log Cleared','User permissions center','warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم مسح السجل'):'تم مسح السجل'); renderSettingsPanel()};
  window.petatoeSaveRole=function(){var v=byId('petRoleSelect')?byId('petRoleSelect').value:'admin';saveSettings({role:v});log('Role Changed','Current role: '+v,'warn');toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حفظ الصلاحية: '):'تم حفظ الصلاحية: '+(ROLE_LABELS[v]||v))};
  window.petatoeSaveValidationSettings=function(){saveSettings({strictValidation:!!byId('strictValidation')?.checked,duplicateProtection:!!byId('duplicateProtection')?.checked,autoFixMonth:!!byId('autoFixMonth')?.checked});log('Validation Settings Updated','Data quality rules updated','info');toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم حفظ قواعد جودة البيانات'):'تم حفظ قواعد جودة البيانات')};
  window.petatoeFixMonthMismatch=function(){
    if(!canWrite()){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('الصلاحية الحالية لا تسمح بالتعديل'):'الصلاحية الحالية لا تسمح بالتعديل');return}
    ...
    if(c){try{_invalidateSearchIndex()}catch(e){smartReportsWarn('search index invalidation skipped after month fix',e)}; try{save()}catch(e){smartReportsWarn('save skipped after month fix',e)}; log('Month Auto Fix','Fixed '+c+' records','warn'); renderSettingsPanel(); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم تصحيح '):'تم تصحيح '+c+' سجل')}else toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لا يوجد اختلاف في الشهور'):'لا يوجد اختلاف في الشهور')
  };
  ...
  window.petatoeClearLogs=function(){if(!canDelete()){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('الصلاحية الحالية لا تسمح بمسح السجل'):'الصلاحية الحالية لا تسمح بمسح السجل');return} if(!confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مسح سجل الحركات؟'):'مسح سجل الحركات؟'))return; removeJSON(LOG_KEY); log('Audit Log Cleared','Log was cleared','warn'); renderLogsPanel();};
  window.petatoeExportLogsExcel=function(){var arr=readJSON(LOG_KEY,[]); if(!window.XLSX){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('مكتبة Excel غير متاحة'):'مكتبة Excel غير متاحة');return} var ws=XLSX.utils.json_to_sheet(arr);var wb=XLSX.utils.book_new();XLSX.utils.book_append_sheet(wb,ws,'Audit Log');XLSX.writeFile(wb,'PETATOE_Audit_Log.xlsx')};
  ...
  window.petatoeExportBackup=function(){
    if(!canBackup()){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('الصلاحية الحالية لا تسمح بالنسخ الاحتياطي'):'الصلاحية الحالية لا تسمح بالنسخ الاحتياطي');return}
  ...
  window.petatoeRestorePicker=function(){if(!canBackup()){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('الصلاحية الحالية لا تسمح بالاسترجاع'):'الصلاحية الحالية لا تسمح بالاسترجاع');return} byId('petatoeRestoreInput')?.click()};
  ...
  window.petatoeRestoreBackup=function(e){
    ...
    reader.onload=function(ev){
      ...
      try{
        ...
        if(!confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('استرجاع النسخة الاحتياطية سيستبدل البيانات الحالية. هل أنت متأكد؟'):'استرجاع النسخة الاحتياطية سيستبدل البيانات الحالية. هل أنت متأكد؟'))return;
        ...
        applyGovernance(); renderSettingsPanel(); log('Backup Restored','Records: '+dsRecords().length,'warn'); toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تم استرجاع النسخة الاحتياطية بنجاح'):'تم استرجاع النسخة الاحتياطية بنجاح')
      }catch(err){console.error(err);toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('ملف Backup غير صالح أو مصدر Supabase غير جاهز'):'ملف Backup غير صالح أو مصدر Supabase غير جاهز')}
    };
  ...
  window.petatoeBeforeSaveRecord=function(){
    if(!canWrite()){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('الصلاحية الحالية لا تسمح بالحفظ'):'الصلاحية الحالية لا تسمح بالحفظ');return false}
    try{
      ...
      var v=validateRecord(r,dsRecords(),window.editingId); if(!v.ok){toastSafe(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لم يتم الحفظ: '):'لم يتم الحفظ: '+v.errors[0]); log('Save Blocked',v.errors.join(' | '),'error');return false}
      if(v.warnings.length && !confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تنبيه جودة بيانات:\n- '):'تنبيه جودة بيانات:\n- '+v.warnings.join('\n- ')+'\nهل تريد الحفظ؟')){log('Save Cancelled',v.warnings.join(' | '),'warn');return false}
