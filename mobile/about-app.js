...
(function(){
  ...
  function version(){return String(window.PETATOE_RELEASE_VERSION||'v10.0.25')}
  function releaseName(){return String(window.PETATOE_RELEASE_NAME||((window.PETATOEVersionManifest&&window.PETATOEVersionManifest.releaseName)||'PETATOE_V10_0_25_ENTERPRISE_PRODUCTION_CERTIFICATION_E5'))}
