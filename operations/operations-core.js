(function(){
  ...
  var APPOINTMENTS_METHODS = [
    ...
    'resetFilters', 'setQuickRange', 'setCalendarView', 'shiftCalendarMonth', 'setCalendarToday', 'openCalendarDayDetails', 'closeCalendarDayDetails', 'openCalendarAppointment', 'applyCustomerSuggestion', 'searchAppointmentCustomers', 'selectAppointmentCustomer', 'syncNewCustomerFields',
    ...
    'saveVehicleAssignment', 'editVehicleAssignment', 'toggleVehicleAssignment', 'removeVehicleAssignment', 'applyVehicleStaffAssignment', 'refreshAvailableAppointmentSlots',
