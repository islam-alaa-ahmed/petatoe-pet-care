...
(function(){
  ...
  window.PETATOEPayroll={
    ...
    cancelApproval:function(id){
      ...
      s.updatedAt=at;
      notifyAfterPersist(saveSlips(arr),'تم إلغاء الاعتماد خطوة واحدة للخلف');
      render();
      renderSalarySlip();
    },
