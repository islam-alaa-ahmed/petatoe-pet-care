...
(function(){
  ...
  register('vehicleOperations', { moduleId:'operations', title:'Vehicle Operations', owner:'operations', panelId:'vehicleOperations', eager:true, lazyCandidate:true, requiresPermission:'vehicleOperations', aliases:['vehicles'], scriptHints:['operations/*.js'] });
