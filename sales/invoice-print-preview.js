...
(function(){
  ...
  function openPrintableInvoice(html, autoPrint){
    if(!html){ alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('افتح معاينة الفاتورة الأول من زر العين أو رقم الفاتورة'):'افتح معاينة الفاتورة الأول من زر العين أو رقم الفاتورة'); return false; }
    ...
    if(!w){ alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المتصفح منع فتح نافذة الطباعة. اسمح بالـ Popups وجرب تاني.'):'المتصفح منع فتح نافذة الطباعة. اسمح بالـ Popups وجرب تاني.'); return false; }
    return true;
  }
