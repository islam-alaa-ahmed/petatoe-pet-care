...
assert(runtime.includes("9.3.1-bulk-localization-refactor")||runtime.includes("9.3.2-runtime-localization-cleanup"),'Unified runtime version not updated');
...
assert(index.includes('i18n/localization-center/runtime.js?v=9.3.1-bulk-localization-refactor')||index.includes('i18n/localization-center/runtime.js?v=9.3.2-runtime-localization-cleanup'),'Runtime cache token not updated');
assert(index.includes('i18n/global-screen-translator.js?v=9.3.1-bulk-localization-refactor')||index.includes('i18n/global-screen-translator.js?v=9.3.2-runtime-localization-cleanup'),'Translator cache token not updated');
assert(version.includes('PETATOE v9.3.1')||version.includes('PETATOE v9.3.2'),'Release version not synchronized');
