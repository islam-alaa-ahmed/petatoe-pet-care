...
const release=fs.readFileSync(path.join(root,'RELEASE_VERSION.txt'),'utf8');if(!release.includes('PETATOE v9.4.15')||!release.includes('PETATOE_V9_4_15_SMART_REPORTS_FAST_RUNTIME_RESTORATION'))failures.push('Release metadata is not synchronized to v9.4.15.');
const runtime=fs.readFileSync(path.join(root,'i18n/localization-center/runtime.js'),'utf8');if(!runtime.includes("VERSION='9.4.15-smart-reports-fast-runtime'"))failures.push('Localization runtime version is not synchronized to v9.4.15.');
