...
const release=fs.readFileSync(path.join(root,'RELEASE_VERSION.txt'),'utf8');if(!release.includes('PETATOE v9.4.8')||!release.includes('ELC_V9_4_8_SETTINGS_LOCALIZATION_MIGRATION_PHASE61'))failures.push('Release metadata is not synchronized to v9.4.8.');
const runtime=fs.readFileSync(path.join(root,'i18n/localization-center/runtime.js'),'utf8');if(!runtime.includes("VERSION='9.4.8-settings-localization-phase61'"))failures.push('Localization runtime version is not synchronized to v9.4.8.');
