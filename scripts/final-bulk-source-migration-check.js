...
if(!((release.includes('PETATOE v9.3.3')&&release.includes('ELC_V9_3_3_FINAL_BULK_SOURCE_MIGRATION'))||(release.includes('PETATOE v9.3.5')&&release.includes('ELC_V9_3_5_FINAL_RESIDUAL_LOCALIZATION_CLEANUP'))||(release.includes('PETATOE v9.3.6')&&release.includes('ELC_V9_3_6_LOCALIZATION_CENTER_CONSOLIDATION')))){
