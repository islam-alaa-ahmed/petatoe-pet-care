...
if(!runtime.includes("VERSION='9.4.13-smart-reports-performance'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.13')||!release.includes('PETATOE_V9_4_13_SMART_REPORTS_RENDER_LOCALIZATION_PERFORMANCE'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.13'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_13_SMART_REPORTS_RENDER_LOCALIZATION_PERFORMANCE'"))fail('index.html release metadata mismatch.');
