...
if(!runtime.includes("VERSION='9.4.11-permissions-runtime-reference-fix'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.11')||!release.includes('PETATOE_V9_4_11_PERMISSIONS_RUNTIME_REFERENCE_FIX'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.11'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_11_PERMISSIONS_RUNTIME_REFERENCE_FIX'"))fail('index.html release metadata mismatch.');
