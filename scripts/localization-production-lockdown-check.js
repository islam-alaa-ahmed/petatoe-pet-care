...
if(!runtime.includes("VERSION='9.4.4-production-lockdown'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.4')||!release.includes('ELC_V9_4_4_PRODUCTION_LOCALIZATION_LOCKDOWN'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.4'")||!index.includes("PETATOE_RELEASE_NAME='ELC_V9_4_4_PRODUCTION_LOCALIZATION_LOCKDOWN'"))fail('index.html release metadata mismatch.');
