...
if(!runtime.includes("VERSION='9.4.8-settings-localization-phase61'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.8')||!release.includes('ELC_V9_4_8_SETTINGS_LOCALIZATION_MIGRATION_PHASE61'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.8'")||!index.includes("PETATOE_RELEASE_NAME='ELC_V9_4_8_SETTINGS_LOCALIZATION_MIGRATION_PHASE61'"))fail('index.html release metadata mismatch.');
