...
if(!runtime.includes("VERSION='10.0.1-canonical-payroll-persistence'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v10.0.1')||!release.includes('PETATOE_V10_0_1_CANONICAL_PAYROLL_PERSISTENCE'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v10.0.1'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V10_0_1_CANONICAL_PAYROLL_PERSISTENCE'"))fail('index.html release metadata mismatch.');
