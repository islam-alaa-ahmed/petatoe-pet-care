...
if(!runtime.includes("VERSION='9.4.12-runtime-translation-completion'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.12')||!release.includes('PETATOE_V9_4_12_RUNTIME_TRANSLATION_COMPLETION'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.12'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_12_RUNTIME_TRANSLATION_COMPLETION'"))fail('index.html release metadata mismatch.');
