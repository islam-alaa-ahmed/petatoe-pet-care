...
if(!runtime.includes("VERSION='9.4.5-localization-performance'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.5')||!release.includes('ELC_V9_4_5_LOCALIZATION_PERFORMANCE_STABILIZATION'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.5'")||!index.includes("PETATOE_RELEASE_NAME='ELC_V9_4_5_LOCALIZATION_PERFORMANCE_STABILIZATION'"))fail('index.html release metadata mismatch.');
