...
if(!runtime.includes("VERSION='9.4.10-smart-reports-key-resolution'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.10')||!release.includes('PETATOE_V9_4_10_SMART_REPORTS_KEY_RESOLUTION'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.10'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_10_SMART_REPORTS_KEY_RESOLUTION'"))fail('index.html release metadata mismatch.');
