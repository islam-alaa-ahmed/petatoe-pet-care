...
if(!runtime.includes("VERSION='9.4.9-startup-permission-guard'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.9')||!release.includes('PETATOE_V9_4_9_STARTUP_PERMISSION_GUARD'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.9'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_9_STARTUP_PERMISSION_GUARD'"))fail('index.html release metadata mismatch.');
