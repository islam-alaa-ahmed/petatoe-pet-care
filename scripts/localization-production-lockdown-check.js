...
if(!runtime.includes("VERSION='9.4.15-smart-reports-fast-runtime'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.15')||!release.includes('PETATOE_V9_4_15_SMART_REPORTS_FAST_RUNTIME_RESTORATION'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.15'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_15_SMART_REPORTS_FAST_RUNTIME_RESTORATION'"))fail('index.html release metadata mismatch.');
