...
if(!runtime.includes("VERSION='9.4.23-operations-localization-completion'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.23')||!release.includes('PETATOE_V9_4_23_OPERATIONS_LOCALIZATION_COMPLETION'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.23'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_23_OPERATIONS_LOCALIZATION_COMPLETION'"))fail('index.html release metadata mismatch.');
