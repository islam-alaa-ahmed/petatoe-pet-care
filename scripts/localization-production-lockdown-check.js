...
if(!runtime.includes("VERSION='9.4.19-localization-ci-certification'"))fail('Localization Center runtime version mismatch.');
...
if(!release.includes('PETATOE v9.4.19')||!release.includes('PETATOE_V9_4_19_LOCALIZATION_CI_CERTIFICATION_FIX'))fail('Release metadata mismatch.');
const index=fs.readFileSync(path.join(root,'index.html'),'utf8');
if(!index.includes("PETATOE_RELEASE_VERSION='v9.4.19'")||!index.includes("PETATOE_RELEASE_NAME='PETATOE_V9_4_19_LOCALIZATION_CI_CERTIFICATION_FIX'"))fail('index.html release metadata mismatch.');
