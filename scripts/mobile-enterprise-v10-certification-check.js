...
requireCheck(worker.includes("const APP_VERSION = '10.0.23-mobile-corrective-parity-c1';"), 'Service Worker version lock', 'Unexpected Service Worker APP_VERSION; update the certification rule with an intentional release change.');
