...
requireCheck(worker.includes("const APP_VERSION = '10.0.25-sg4-6-5-smart-reports-nonblocking-navigation-1';"), 'Service Worker version lock', 'Unexpected Service Worker APP_VERSION; update the certification rule with an intentional release change.');
