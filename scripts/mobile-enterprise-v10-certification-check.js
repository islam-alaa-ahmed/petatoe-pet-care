...
requireCheck(worker.includes("const APP_VERSION = '10.0.25-smart-reports-sr6-1-cache-reconciliation';"), 'Service Worker version lock', 'Unexpected Service Worker APP_VERSION; update the certification rule with an intentional release change.');
