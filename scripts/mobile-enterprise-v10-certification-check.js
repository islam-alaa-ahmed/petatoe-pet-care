...
requireCheck(worker.includes("const APP_VERSION = '10.0.17-core-bootstrap-split-r5';"), 'Service Worker version lock', 'Unexpected Service Worker APP_VERSION; update the certification rule with an intentional release change.');
