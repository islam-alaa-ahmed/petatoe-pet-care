...
check(gate.includes("group === 'smartReports' || group === 'salesRecords'") || (gate.includes('nonBlockingBusinessGroups') && gate.includes('salesRecords:true')),'records navigation is non-blocking while hydration runs');
...
check(manifest.runtimeContracts.recordsRouteHydration==='10.0.25-phase-d1-1-records-nonblocking-hydration-contract-1','records route hydration runtime contract is registered');
