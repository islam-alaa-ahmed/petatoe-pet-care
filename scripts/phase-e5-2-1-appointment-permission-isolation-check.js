...
const checks=[
  ['permission isolation contract registered',['10.0.25-phase-e5-2-1-reference-only-loader-contract-1','10.0.25-phase-e5-2-2-confirmed-vehicle-assignment-persistence-contract-1'].includes(version.runtimeContracts.appointmentPermissionIsolation)],
