...
check('navigation runtime contract recorded', version.runtimeContracts && ['10.0.25-phase6-navigation-intent-contract-1','10.0.25-phase-e1-smart-active-state-contract-1','10.0.25-phase-e2-navigation-guard-replay-contract-1','10.0.25-phase-e3-previous-route-lifecycle-contract-1'].includes(version.runtimeContracts.navigationRuntime));
