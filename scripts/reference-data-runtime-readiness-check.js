...
check(index.includes('10.0.25-sg3-commission-runtime-ownership-1'),'HTML assets use new runtime cache token');
check(worker.includes("const APP_VERSION = '10.0.25-sg3-commission-runtime-ownership-1';"),'service worker namespace rotated');
