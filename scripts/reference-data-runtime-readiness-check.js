...
check(index.includes('10.0.25-sg4-6-2-smart-reports-initial-data-hydration-1'),'HTML assets use new runtime cache token');
check(worker.includes("const APP_VERSION = '10.0.25-sg4-6-2-smart-reports-initial-data-hydration-1';"),'service worker namespace rotated');
