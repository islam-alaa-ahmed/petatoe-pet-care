...
check(index.includes('10.0.25-sg2-runtime-validation-1'),'HTML assets use new runtime cache token');
check(worker.includes("const APP_VERSION = '10.0.25-sg2-runtime-validation-1';"),'service worker namespace rotated');
