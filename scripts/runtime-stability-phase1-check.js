...
assert(runtime.includes("9.3.1-bulk-localization-refactor")||runtime.includes("9.3.2-runtime-localization-cleanup")||runtime.includes("9.3.3-final-bulk-source-migration")||runtime.includes("9.3.5-final-residual-localization-cleanup")||runtime.includes("9.3.6-localization-center-consolidation")||runtime.includes("9.3.6-localization-center-consolidation"),'Localization center runtime version is synchronized');
...
['i18n/localization-center/runtime.js','i18n/global-screen-translator.js'].forEach(file=>assert(html.includes(file+'?v=9.3.1-bulk-localization-refactor')||html.includes(file+'?v=9.3.2-runtime-localization-cleanup')||html.includes(file+'?v=9.3.3-final-bulk-source-migration')||html.includes(file+'?v=9.3.5-final-residual-localization-cleanup')||html.includes(file+'?v=9.3.6-localization-center-consolidation'),file+' cache token synchronized'));
