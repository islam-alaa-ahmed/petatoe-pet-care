...
if(!release.includes('PETATOE v9.4.14')||!release.includes('PETATOE_V9_4_14_SMART_REPORTS_DATA_READINESS_RECOVERY'))failures.push('Release metadata mismatch.');
if(!runtime.includes("VERSION='9.4.14-smart-reports-performance'"))failures.push('Runtime version mismatch.');
