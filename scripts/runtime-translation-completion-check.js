...
if(!release.includes('PETATOE v9.4.20')||!release.includes('PETATOE_V9_4_20_SMART_REPORTS_TRANSLATION_STABILITY_PERFORMANCE_CERTIFICATION'))failures.push('Release metadata mismatch.');
if(!runtime.includes("VERSION='9.4.20-translation-stability-certification'"))failures.push('Runtime version mismatch.');
