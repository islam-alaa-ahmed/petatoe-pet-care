...
check(index.includes('smart/smart-router.js?v=10.0.25-sg4-6-4-smart-reports-load-before-open-1'),'router cache token must be rotated');
check(index.includes('smart/smart-reports-runtime-controller.js?v=10.0.25-sg4-6-4-smart-reports-load-before-open-1'),'runtime cache token must be rotated');
