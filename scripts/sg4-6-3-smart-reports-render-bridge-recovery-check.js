...
check(index.includes('smart/smart-router.js?v=10.0.25-sg4-6-9-smart-reports-soft-ui-dependency-1'),'router cache token must be rotated');
check(index.includes('smart/smart-reports-runtime-controller.js?v=10.0.25-sg4-6-9-smart-reports-soft-ui-dependency-1'),'runtime cache token must be rotated');
