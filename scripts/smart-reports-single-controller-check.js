...
requireTrue(!controller.includes("window.addEventListener('petatoe:records-changed'"),'controller must not own raw records-changed');
requireTrue(controller.includes("window.addEventListener('petatoe:sales-records-committed'"),'controller must render from canonical committed event');
...
console.log('Smart Reports single-controller certification: PASSED (9/9)');
