...
const checks = [
  ['gate cache token', index.includes('10.0.25-sg4-6-5-smart-reports-nonblocking-navigation-1')],
  ...
  ['children bridge deferred', /registerOrWrite\('children','inline-extracted\/children-expenses-core\.js(?:\?v=[^']+)?',false\)/.test(index)],
