...
const checks = [
  ['gate cache token', index.includes('10.0.25-p1-2-startup-decomposition')],
  ...
  ['generic ensure loader', gate.includes('if(!shouldLazyLoad(name)) return waitForDesktopGroup(name);')],
