...
check(index.includes('performance/mobile-startup-loading-gate.js?v=10.0.25-sg4-6-2-smart-reports-initial-data-hydration-1'), 'HTML uses stabilization cache token');
check(worker.includes("const APP_VERSION = '10.0.25-sg4-6-2-smart-reports-initial-data-hydration-1';"), 'service worker cache namespace matches');
