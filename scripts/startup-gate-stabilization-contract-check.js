...
const contracts = ['xlsx','operations','warehouses','treasury','children','commission','settingsSetup','diagnostics','fleet','obligations','movement','localizationRemote','payroll','smartReports','reportsUI','sales','printing'];
...
check(index.includes('performance/mobile-startup-loading-gate.js?v=10.0.25-startup-gate-stabilization-1'), 'HTML uses stabilization cache token');
check(worker.includes("const APP_VERSION = '10.0.25-startup-gate-stabilization-1';"), 'service worker cache namespace matches');
