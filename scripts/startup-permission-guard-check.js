...
if(!index.includes('treasury/treasury-core.js?v='+version.cacheVersion))failures.push('Treasury cache token is not synchronized with the canonical cache version.');
