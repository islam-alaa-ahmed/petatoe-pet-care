...
const APP_VERSION = '10.0.25-sg4-6-4-smart-reports-load-before-open-1';
...
const APP_SHELL = [
  ...
  './pwa/pwa-manager.js',
  './performance/mobile-startup-loading-gate.js?v=10.0.25-sg4-6-4-smart-reports-load-before-open-1',
