...
const APP_VERSION = '10.0.25-phase-e5-2-22-program-wide-localization-certification-1';
...
const APP_SHELL = [
  ...
  './pwa/pwa-manager.js',
  './performance/mobile-startup-loading-gate.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './performance/mobile-runtime-coordinator.js',
  './runtime/version-manifest.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './templates/PETATOE_Customer_Import_Template.xlsx',
  './css/main.css',
  './css/components/interaction-ownership.css?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './security/session-timeout.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './components/security-hardening.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './security/enterprise-security-hardening.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './security/security-offline-contract.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './security/password-security.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './security/auth-session.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './data/data-source.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './data/records-read-facade.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
  './supabase-config.js?v=8.0.2-client1',
  './supabase-client.js?v=8.0.2-client1',
  './core/supabase-repository.js?v=10.0.25-phase-e5-2-22-program-wide-localization-certification-1',
