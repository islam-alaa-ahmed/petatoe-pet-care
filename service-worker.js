...
const APP_VERSION = '10.0.25-phase6-navigation-lazy-route-integrity-1';
...
const APP_SHELL = [
  ...
  './pwa/pwa-manager.js',
  './performance/mobile-startup-loading-gate.js?v=10.0.25-phase6-navigation-lazy-route-integrity-1',
