...
const APP_VERSION = '10.0.25-phase7-readiness-contract-hardening-1';
...
const APP_SHELL = [
  ...
  './pwa/pwa-manager.js',
  './performance/mobile-startup-loading-gate.js?v=10.0.25-phase7-readiness-contract-hardening-1',
