...
const APP_VERSION = '10.0.25-sg4-6-7-router-owned-smart-reports-hydration-1';
...
const APP_SHELL = [
  ...
  './pwa/pwa-manager.js',
  './performance/mobile-startup-loading-gate.js?v=10.0.25-sg4-6-7-router-owned-smart-reports-hydration-1',
