...
(function(){
  ...
  function render(main,sub){
    ...
    if(main==='settings' && sub==='security') setTimeout(function(){ if(typeof window.petV9LoadTrustedDevices==='function') window.petV9LoadTrustedDevices(); }, 120);
  }
