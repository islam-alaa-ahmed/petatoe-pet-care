...
(function(){
  ...
  function setupTypeMeta(type){var map={
    services:{ico:'🛠️',title:'الخدمات',single:'خدمة',formTitle:'إضافة / تعديل خدمة',listTitle:'سجل الخدمات',importBtn:true,fields:[['code','كود الخدمة','text'],['name','الاسم الأساسي / المطابق للبيانات','text'],['name_ar','اسم الخدمة بالعربية','text'],['name_en','Service Name (English)','text'],['name_fil','Pangalan ng Serbisyo (Filipino)','text'],['category','تصنيف الخدمة','text'],['price','السعر (SAR)','number'],['description','الوصف','text'],['status','حالة الخدمة','select']]},
    cars:{ico:'🚐',title:'السيارات',single:'سيارة',formTitle:'إضافة / تعديل سيارة',listTitle:'سجل السيارات',importBtn:true,fields:[['code','كود السيارة','text'],['name','الاسم الأساسي / المطابق للبيانات','text'],['name_ar','اسم السيارة بالعربية','text'],['name_en','Vehicle Name (English)','text'],['name_fil','Pangalan ng Sasakyan (Filipino)','text'],['plate','رقم اللوحة','text'],['driver','السائق / المسؤول','text'],['status','حالة السيارة','select']]},
    customers:{ico:'👥',title:'العملاء',single:'عميل',formTitle:'إضافة / تعديل عميل',listTitle:'سجل العملاء',importBtn:true,fields:[['code','كود العميل','text'],['name','الاسم الأساسي / المطابق للبيانات','text'],['name_ar','اسم العميل بالعربية','text'],['name_en','Customer Name (English)','text'],['name_fil','Pangalan ng Customer (Filipino)','text'],['phone','الهاتف','text'],['notes','ملاحظات','text'],['status','حالة العميل','select']]},
