...
function renderSmartReports(){
  ...
  // PETATOE v9.4.17: Keep canonical records in the calculation layer.
  // Business names are localized only when rendered through smart*Display helpers.
