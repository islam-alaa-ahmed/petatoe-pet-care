(function(){
  ...
  var treasuryAuditPersistQueue=Promise.resolve();
  ...
  function addAudit(action,before,after,reason){
    ...
    publishTreasuryStore();
    treasuryAuditPersistQueue=treasuryAuditPersistQueue.catch(function(){return null}).then(function(){return saveAuditToSupabase()}).then(function(res){if(res&&res.ok===false)throw new Error(res.error||'Treasury audit save failed');return res||{ok:true}});
    return treasuryAuditPersistQueue;
  }

  function dataRows(){
    try{
      if(window.PETATOERecordsReadFacade && typeof window.PETATOERecordsReadFacade.readRows==='function'){
        var canonical=window.PETATOERecordsReadFacade.readRows();
  ...
  async function handover(){
    ...
    if(!v)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اختر السيارة أولاً'):'اختر السيارة أولاً'); if(amt<=0)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب مبلغ صحيح أكبر من صفر'):'اكتب مبلغ صحيح أكبر من صفر'); if(!rec)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب اسم المسؤول المستلم'):'اكتب اسم المسؤول المستلم'); if(amt>vehicleBalance(v)+0.0001)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المبلغ أكبر من رصيد خزنة السيارة المتاح'):'المبلغ أكبر من رصيد خزنة السيارة المتاح');
    var tx={id:todayId('TR'),type:'handover',vehicle:v,amount:amt,receiver:rec,method:method,notes:notes,time:now()}; var saved=await saveTxToSupabase(tx); if(!saved.ok)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('فشل حفظ حركة الخزينة في Supabase: '):'فشل حفظ حركة الخزينة في Supabase: '+(saved.error||'')); var a=getTx();a.push(tx);setTx(a);try{await addAudit('تسليم كاش',null,tx,'إنشاء حركة تسليم')}catch(auditError){console.warn('Treasury audit persistence failed',auditError)}clearForm();renderAll();toastMsg('تم تسليم الكاش وتحويله للخزنة الرئيسية');
  }
  async function expense(){
    ...
    if(!cat)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب أو اختر جهة / بند الصرف'):'اكتب أو اختر جهة / بند الصرف'); if(!rec)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب المسؤول أو المستلم'):'اكتب المسؤول أو المستلم'); if(!ref)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب مرجع حركة الصرف'):'اكتب مرجع حركة الصرف'); if(amt<=0)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب مبلغ صحيح أكبر من صفر'):'اكتب مبلغ صحيح أكبر من صفر'); if(amt>vaultBalance(src)+0.0001)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المبلغ أكبر من رصيد الخزنة المحددة'):'المبلغ أكبر من رصيد الخزنة المحددة');
    var tx={id:todayId('EX'),type:'expense',source:src,vehicle:src===OWNER?'':src,category:cat,amount:amt,receiver:rec,ref:ref,notes:notes,time:now()}; var saved=await saveTxToSupabase(tx); if(!saved.ok)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('فشل حفظ حركة الخزينة في Supabase: '):'فشل حفظ حركة الخزينة في Supabase: '+(saved.error||'')); var a=getTx();a.push(tx);setTx(a);var cc=getCats();cc.push(cat);setCats(cc);try{await addAudit('صرف خزينة',null,tx,'إنشاء حركة صرف')}catch(auditError){console.warn('Treasury audit persistence failed',auditError)}clearExpenseForm();renderAll();toastMsg('تم تسجيل حركة الصرف');
  }
  ...
  async function editTx(id){
    var h=findTx(id); if(!h)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لم يتم العثور على الحركة'):'لم يتم العثور على الحركة'); var t=Object.assign({},h.tx); if(t.type!=='handover'&&t.type!=='expense')return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('هذه حركة فاتورة ولا يتم تعديلها من الخزينة'):'هذه حركة فاتورة ولا يتم تعديلها من الخزينة');
    var reason=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('سبب التعديل'):'سبب التعديل'); if(reason===null)return; reason=clean(reason); if(!reason)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('سبب التعديل مطلوب'):'سبب التعديل مطلوب');
    var amt=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المبلغ الجديد'):'المبلغ الجديد',String(num(t.amount).toFixed(2))); if(amt===null)return; amt=num(amt); if(amt<=0)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('اكتب مبلغ صحيح'):'اكتب مبلغ صحيح');
    var rec=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المسؤول / المستلم'):'المسؤول / المستلم',clean(t.receiver)); if(rec===null)return; rec=clean(rec); if(!rec)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المسؤول مطلوب'):'المسؤول مطلوب');
    var notes=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('ملاحظات'):'ملاحظات',clean(t.notes)); if(notes===null)return; notes=clean(notes);
    if(t.type==='handover'){var method=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('طريقة التسليم'):'طريقة التسليم',clean(t.method)||METHODS[0]); if(method===null)return; if(amt>vehicleBalance(clean(t.vehicle),id)+0.0001)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المبلغ أكبر من الرصيد المتاح بعد استبعاد الحركة الحالية'):'المبلغ أكبر من الرصيد المتاح بعد استبعاد الحركة الحالية'); t.method=clean(method)||METHODS[0]; t.receiver=rec; t.notes=notes;}
    if(t.type==='expense'){var cat=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('جهة / بند الصرف'):'جهة / بند الصرف',clean(t.category)); if(cat===null)return; cat=clean(cat); if(!cat)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('البند مطلوب'):'البند مطلوب'); var ref=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المرجع'):'المرجع',clean(t.ref)); if(ref===null)return; ref=clean(ref); if(!ref)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المرجع مطلوب'):'المرجع مطلوب'); var src=clean(t.source||t.vehicle||OWNER); if(amt>vaultBalance(src,id)+0.0001)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('المبلغ أكبر من الرصيد المتاح بعد استبعاد الحركة الحالية'):'المبلغ أكبر من الرصيد المتاح بعد استبعاد الحركة الحالية'); t.category=cat;t.ref=ref;t.receiver=rec;t.notes=notes;}
    var before=Object.assign({},h.tx); t.amount=amt;t.updatedAt=now(); var saved=await saveTxToSupabase(t); if(!saved.ok)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('فشل تحديث حركة الخزينة في Supabase: '):'فشل تحديث حركة الخزينة في Supabase: '+(saved.error||'')); h.arr[h.index]=t; setTx(h.arr); try{await addAudit('تعديل حركة خزينة',before,t,reason)}catch(auditError){console.warn('Treasury audit persistence failed',auditError)} renderAll(); toastMsg('تم تعديل الحركة');
  }
  async function deleteTx(id){var h=findTx(id); if(!h)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('لم يتم العثور على الحركة'):'لم يتم العثور على الحركة'); if(h.tx.type!=='handover'&&h.tx.type!=='expense')return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('هذه حركة فاتورة ولا يتم حذفها من الخزينة'):'هذه حركة فاتورة ولا يتم حذفها من الخزينة'); var reason=prompt(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('سبب الحذف'):'سبب الحذف'); if(reason===null)return; reason=clean(reason); if(!reason)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('سبب الحذف مطلوب'):'سبب الحذف مطلوب'); if(!confirm(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('تأكيد حذف الحركة؟'):'تأكيد حذف الحركة؟'))return; var removed=await deleteTxFromSupabase(id); if(!removed.ok)return alert(window.PETATOE_LOCALIZATION_CENTER&&window.PETATOE_LOCALIZATION_CENTER.translateRuntime?window.PETATOE_LOCALIZATION_CENTER.translateRuntime('فشل حذف حركة الخزينة من Supabase: '):'فشل حذف حركة الخزينة من Supabase: '+(removed.error||'')); var before=Object.assign({},h.tx); h.arr.splice(h.index,1); setTx(h.arr); try{await addAudit('حذف حركة خزينة',before,null,reason)}catch(auditError){console.warn('Treasury audit persistence failed',auditError)} renderAll(); toastMsg('تم حذف الحركة');}
