(function(){
  ...
  function openTreasuryTab(tab,silent){
    ...
    if(!canTreasuryTab(tab)){var fb=firstAllowedTreasuryTab(); if(!fb){activeTreasuryTab='';return alert('غير متاح للصلاحية الحالية');} tab=fb;}
